...
export default function MemberSidebar() {
  ...
  return (
    <aside className={`sidebar ${collapsed ? "collapsed" : ""}`}>
      ...
      <style>{`
        .sidebar { width: 230px; min-height: 100vh; background: #111113; border-right: 1px solid rgba(255,255,255,0.06); display: flex; flex-direction: column; transition: width 0.25s ease; flex-shrink: 0; position: sticky; top: 0; height: 100vh; }
