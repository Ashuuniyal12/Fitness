...
const STORAGE_KEY = "maximus-member-pwa-dismiss";
      ...
      <div className="pwa-banner">
        <div className="pwa-banner-icon">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
            <path d="M6.5 6.5h2M15.5 6.5h2M4 9h1m14 0h1M3 12h18M4 15h1m14 0h1M6.5 17.5h2M15.5 17.5h2"/>
          </svg>
        </div>
        <div className="pwa-banner-content">
          <div className="pwa-banner-title">Install Maximus</div>
          {isIOS ? (
            <div className="pwa-banner-sub">
              Tap <strong>Share</strong> then <strong>"Add to Home Screen"</strong> in Safari
            </div>
          ) : (
            <div className="pwa-banner-sub">Track your fitness anywhere, even offline</div>
          )}
        </div>
