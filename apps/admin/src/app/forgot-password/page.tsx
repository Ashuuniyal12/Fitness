  ...
  return (
    <div className="auth-page">
          ...
          {success ? (
            ...
            <>
              ...
              <form onSubmit={handleReset} className="auth-form">
                ...
                <button id="reset-btn" type="submit" className="auth-btn-primary" disabled={loading}>
      ...
      <style>{`
        ...
        .form-input { width: 100%; background: rgba(39,39,42,0.8); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 12px 14px 12px 42px; color: #f4f4f5; font-size: 14px; font-family: 'Montserrat', sans-serif; outline: none; transition: border-color 0.2s, box-shadow 0.2s; }
